...
| 10 | **AI Creative Engine vNext** (10.1-10.9, see ADR above, includes Bundle Composition) | done (10.1-10.9, live-verified with real, paid provider calls throughout — see reports log). Phase 10.6b (Downie fallback importer) remains separately deferred, not part of 10.1-10.9's scope |
