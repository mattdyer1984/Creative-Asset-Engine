...
# ---------------------------------------------------------------------------
# Slideshow/Slide (new pipeline) - Phase 2.5 of the Slideshow/Slide
# migration. Deliberately new classes, not modifications of the ones
# above: the old schemas continue to serve /api/creatives/* unchanged;
# these serve the new /api/slideshows/* surface. See the migration
# roadmap for why both exist side by side until Phase 2.7.
# ---------------------------------------------------------------------------
